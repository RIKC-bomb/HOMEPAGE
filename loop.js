...
(function () {
  ...
  var DATA = {
    modeling:{k:'モデリング',
      ja:'ポリゴンや曲面で、物体や空間の形を一からつくる工程。粘土のように削り込む<span class="seed">sculpting</span>、表面に色と質感を与える<span class="seed">texturing</span>、光を置いて陰影をつくる<span class="seed">lighting</span>、動きを付ける<span class="seed">animation</span>、計算して画像に仕上げる<span class="seed">rendering</span>──いずれも、見えるものにする<span class="seed">visualization</span>ための工程である。',
      en:'Building the form of objects and spaces from scratch with polygons and surfaces. Carving like clay <span class="seed">sculpting</span>, giving surfaces color and material <span class="seed">texturing</span>, placing light for shadow <span class="seed">lighting</span>, adding movement <span class="seed">animation</span>, computing it into an image <span class="seed">rendering</span> — all are steps toward making something visible <span class="seed">visualization</span>.'},
    simulation:{k:'シミュレーション',
      ja:'現象を手で描かず、ルールに沿って計算で動かす工程。流体・布・破壊などが対象になる。小さなコードを書く<span class="seed">scripting</span>、道具やシステムを組む<span class="seed">programming</span>、コードを書く<span class="seed">coding</span>、規則から形を生成する<span class="seed">generation</span>、数値を計算する<span class="seed">calculation</span>が、その手段にあたる。',
      en:'Computing phenomena by rules instead of drawing motion by hand. Fluids, cloth and destruction are typical subjects. The means include writing small code <span class="seed">scripting</span>, building tools and systems <span class="seed">programming</span>, writing code <span class="seed">coding</span>, generating form from rules <span class="seed">generation</span>, and running numerical computation <span class="seed">calculation</span>.'},
    perception:{k:'パーセプション',
      ja:'ものの見え方に関わる領域。同じ対象でも、視点<span class="seed">perspective</span>が変われば違って見える。どこから・どう見せるかを選び、伝わる像へ翻訳する<span class="seed">visualization</span>までを扱う。',
      en:'The domain of how things appear. The same subject looks different as the point of view <span class="seed">perspective</span> changes. It covers choosing where and how to show something, and translating it into an image that reads <span class="seed">visualization</span>.'}
  };
