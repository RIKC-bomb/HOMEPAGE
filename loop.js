...
(function () {
  ...
  deck.addEventListener('pointerdown', function (e) {
    if (e.pointerType === 'mouse') return; // マウスは文章の選択・コピーを優先（スクロールはホイールで）
